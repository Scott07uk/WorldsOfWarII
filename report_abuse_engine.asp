...
strRedir = "report_form.asp?type=abuse&username=" & strusername & "&con=" & Request.Form("continent") & "&country=" & Request.Form("country") & "&details=" & strdetails
...
if strDetails = "" then
		...
		if strLocation = "" then
				...
				strsql = "SELECT * FROM tblAbuseReports ORDER BY ReportID DESC;"
