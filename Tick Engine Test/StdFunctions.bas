...
'On Error GoTo errorCatch
    ...
    '**************************************
    '* UNCOMMENT FOR REAL TICK PROCESSING *
    '**************************************
    ...
    Call calScore
    Call voteValidation
    Call setWoWLock(False)
    
    'end of the tick processing
    
    main.gamestats.Caption = "TICK SUCCESSFULLY PROCESSED"
...
Printer.Print "ERROR NUMBER:" & Err.Number
Printer.Print Err.Description
Printer.Print Err.Source
Printer.Print Err.LastDllError
Printer.EndDoc
main.SQLCon.ConnectionString = "Provider=SQLOLEDB;Server=neptune;User ID=WoWTick;Password=therealtickengine;Database=WoWII;"

main.SQLCon2.ConnectionString = "Provider=SQLOLEDB;Server=neptune;User ID=WoWTick;Password=therealtickengine;Database=WoWII;"
