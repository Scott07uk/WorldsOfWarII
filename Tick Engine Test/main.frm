...
SQLCon2.LockType = 3
SQLCon2.CursorType = 2
SQLCon.CommandTimeout = 15
SQLCon2.CommandTimeout = 15
...
'set the lock file address
strLockFile = "\\neptune\iis\wowii\tick_control.asp"

'loading is done

End Sub

Private Sub SQLCon_Error(ByVal ErrorNumber As Long, Description As String, ByVal Scode As Long, ByVal Source As String, ByVal HelpFile As String, ByVal HelpContext As Long, fCancelDisplay As Boolean)
Printer.Print "ERROR REPORT"
Printer.Print "ERROR NUMBER:" & ErrorNumber
Printer.Print Description
Printer.Print Scode
Printer.Print Source
Printer.EndDoc
gamestats.Caption = gamestats.Caption & "SQL Connection Thread 1 has reported an error code " & ErrorNumber & vbCrLf
SQLCon.ConnectionString = "Provider=SQLOLEDB;Server=neptune;User ID=WoWTick;Password=therealtickengine;Database=WoWII;"
SQLCon.Refresh
End Sub


Private Sub SQLCon2_Error(ByVal ErrorNumber As Long, Description As String, ByVal Scode As Long, ByVal Source As String, ByVal HelpFile As String, ByVal HelpContext As Long, fCancelDisplay As Boolean)
Printer.Print "ERROR REPORT"
Printer.Print "ERROR NUMBER:" & ErrorNumber
Printer.Print Description
Printer.Print Scode
Printer.Print Source
Printer.EndDoc
gamestats.Caption = gamestats.Caption & "SQL Connection Thread 2 has reported an error code " & ErrorNumber & vbCrLf
SQLCon2.ConnectionString = "Provider=SQLOLEDB;Server=neptune;User ID=WoWTick;Password=therealtickengine;Database=WoWII;"
SQLCon2.Refresh
End Sub
